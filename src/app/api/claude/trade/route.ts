...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    try {
      console.log('[DEBUG] Trade: About to run enhanced risk analysis, flags:', {
      ...
      console.log('[DEBUG] Trade: Enhanced risk analysis completed, has riskSummary:', !!enhancedAnalysis.riskSummary);
    } catch (error) {
      // Fail closed: log error in dev but continue with original analysis
      console.error('[Enhanced Risk Analysis] Trade endpoint failed, returning original analysis:', error);
    }
